...
if __name__ == "__main__":
    ...
    for page in range(1, 371):
        ...
        for movie in range(1, 25):
            ...
            #
            movie_link = driver.find_element(By.XPATH, '//*[@id="main-container main-container-default"]/section/section[1]/section/div/main/div/section/section/div/section[{0}]/div/article/figure/a'.format(movie))
            

            download_url_db = driver.current_url
            movie_name = download_url_db.split('/')[-1]
            if movieDB.findFromTableCnamaSeries(movie_name):
                continue
            movie_link.click()
            sleep(3)
